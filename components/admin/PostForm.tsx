            ...
            <SectionCard title="Basics" description="What readers see as the title, and where the page lives.">
              <Field label="Title (H1 on the page)">
                <input
                  ...
                  placeholder="e.g. Thames River Cruise Guide: Tickets, Hours & Insider Tips"
                />
              </Field>
              ...
              <div className="grid gap-5 sm:grid-cols-2">
                ...
                >
                  <input
                    ...
                    placeholder="thames-river-cruise-tickets-guide"
                  />
                </Field>
                <Field label="Category" hint="Controls the category badge and sidebar category filters.">
                  <input
                    ...
                    className={inputClass}
                    placeholder="e.g. Visitor Guide, Thames River Cruise Tickets, Tickets & Prices"
                  />
                </Field>
              </div>

              <div className="grid gap-5 sm:grid-cols-3">
                <Field label="Author" hint="e.g. Camille Dubois / Thames Travel Writer">
                  <input
                    value={post.author || ""}
            ...
            <SectionCard title="Focus keyword" description="The main phrase you want this post to rank for. Purely a writing aid — nothing here is sent to Google.">
              <Field label="Focus keyword">
                <input
                  ...
                  className={inputClass}
                  placeholder="e.g. Thames River Cruise Tickets"
                />
              </Field>
              {focusChecklist && (
