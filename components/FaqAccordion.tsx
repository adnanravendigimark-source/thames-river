        ...
        return (
          <div
            ...
            className={`overflow-hidden rounded-2xl border bg-white shadow-sm transition-all duration-200 ${
              open ? "border-[#1E96E0] shadow-md" : "border-gray-200 hover:border-gray-300"
            }`}
          >
            <button
              type="button"
              ...
              aria-expanded={open}
              className="flex w-full cursor-pointer list-none items-center justify-between gap-3 p-5 text-left font-semibold text-[#0B2545] sm:p-5.5"
            >
              ...
              <span
                className={`flex h-6 w-6 shrink-0 items-center justify-center rounded-full border border-gray-200 text-xs transition ${
                  open ? "rotate-45 bg-[#0B2545] text-white" : "bg-gray-50 text-[#0B2545]"
                }`}
              >
                +
              </span>
            ...
            {open && (
              <div
                className="rich-content border-t border-gray-100 px-5 pb-5 pt-3 text-xs sm:text-[13px] leading-relaxed text-[#1C2B3A]/85 sm:px-5.5"
