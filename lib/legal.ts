...
const DEFAULT_PRIVACY_POLICY: PrivacyPolicy = {
  ...
  noFollow: false,
  canonicalUrl: "",
  metaTitle: "Privacy Policy | Versailles Palace Tickets",
  metaDescription: "Privacy Policy for Versailles Palace Tickets — how we protect your information when exploring Versailles passes and Paris travel guides.",
  ogTitle: "",
  ogDescription: "",
  ogImage: "",
};
