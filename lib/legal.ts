...
const DEFAULT_PRIVACY_POLICY: PrivacyPolicy = {
  ...
  noFollow: false,
  canonicalUrl: "",
  metaTitle: "Privacy Policy | Thames River Cruises",
  metaDescription: "Privacy Policy for Thames River Cruises — how we protect your information when exploring Thames cruise tickets and London travel guides.",
  ogTitle: "",
  ogDescription: "",
  ogImage: "",
};
